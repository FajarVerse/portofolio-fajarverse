...
const CardHeader = ({ image }: CardHeaderProps) => {
  return (
    <div
      className="w-full h-64 bg-cover bg-center md:h-80 lg:h-64 xl:h-72 2xl:h-80"
  ...
  return (
    <>
      <div className="w-full mt-3.5">
        <h2 className="font-mono font-bold text-lg text-primary md:text-2xl lg:text-xl xl:text-2xl 2xl:text-3xl">{title}</h2>
        <p className="font-sans font-medium text-sm text-primary md:text-base md:mt-1.5 lg:text-sm xl:text-base 2xl:mt-2">{children}</p>
      </div>
