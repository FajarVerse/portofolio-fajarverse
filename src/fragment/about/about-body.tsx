      ...
      <BlurFade inView={true} direction={"right"} offset={10} duration={0.5}>
        <div className="w-full mt-4 lg:mt-5 xl:mt-7">
          ...
          <Paragraph className="mt-3 xl:mt-5">
            ...
            to ensure every digital product I build is not only efficient but
            also <span className="text-primary">engaging and intuitive</span> to
            use. I believe technology is more than just a tool — it’s a{" "}
            <span className="text-primary">
